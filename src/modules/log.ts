...
export class Log implements ILog {
	...
	public debug (msg, ...args) { this.write(this.severities.Debug, msg, args); }
	public d (msg, ...args) { this.write(this.severities.Debug, msg, args); }
	public verbose (msg, ...args) { this.write(this.severities.Verbose, msg, args); }
	public v (msg, ...args) { this.write(this.severities.Verbose, msg, args); }
	public info (msg, ...args) { this.write(this.severities.Info, msg, args); }
	public i (msg, ...args) { this.write(this.severities.Info, msg, args); }
	public warning (msg, ...args) { this.write(this.severities.Warning, msg, args); }
	public w (msg, ...args) { this.write(this.severities.Warning, msg, args); }
	public error (msg, ...args) { this.write(this.severities.Error, msg, args); }
	public e (msg, ...args) { this.write(this.severities.Error, msg, args); }
	public fatal (msg, ...args) { this.write(this.severities.Fatal, msg, args); }

	public write(severity: LogLevel, msg, args) {
		...
		switch(severity) {
			case this.severities.Debug: 	func='log'; 	prefix=" [DBG]"; style+="font-size:10px;"; break;
			case this.severities.Verbose: 	func='log'; 	prefix=" [v]"; break;
			case this.severities.Info: 		func='info'; 	prefix=" [>>]"; break;
			case this.severities.Warning: 	func='warn'; 	prefix=" [*]"; break;
			case this.severities.Error: 	func='error'; 	prefix=" [!]"; break;
			case this.severities.Fatal: 	func='error'; 	prefix=" [!!!]"; style+="color:red;"; break;
		}
	...
	public color(str: string, color: ConsoleColors) {
		...
		if (c == null && ConsoleColors[color] == null) throw "given color ({0}) is not supported. options: black, red, green, yellow, blue, magenta, cyan, white".format(color);
